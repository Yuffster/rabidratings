...
///////////////////////////////////////////////////////////////////////////////
		...
		$prefix = "rabid_";                   //The prefix to the db table.
...
///////////////////////////////////////////////////////////////////////////////
	...
	function getStarMessage($rating) {
		...
		return "$stars/$this->stars stars ($rating[totalRatings] vote$s)";
	}
	...
	function ensureTables() {
		...
		if (!$this->allowDuplicates) {
			$unique = "UNIQUE ( `ratable_id` , `ip_address`),";
		}
